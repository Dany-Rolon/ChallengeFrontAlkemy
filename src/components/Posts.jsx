        ...
        <div className="w-full">
            <div className="border-2 p-2 m-2 rounded-md shadow-lg">
                ...
                <div className="flex mt-2">
                    ...
                    <Link to={`/eliminar/${post.id}/${post.title}`} className="text-center text-red-400 w-full rounded-md border-2 border-red-400 m-1 font-semibold hover:bg-red-700 hover:text-white">Eliminar</Link>
                </div>
            </div>
        </div>
    );
